...
names=["CETRIS";"HANKA"];
desc=["Mìøení cementotøískových desek";...
    "Mìøení lomové energie na alkalicky aktivovaných trámeècích o rozmìrech 40x40x160 mm"];
...
for i=IDs'
    ...
    for j=1:rand(20)*10
        data=table(i,datetime(2021,12,31,'Format','yyyy-MM-dd hh:mm:ss'),...
            int16(rand(1)*100),string([cd '\Master\']),"Popis mìøení v daném dni",'VariableNames',...
